...
Item {
    ...
    ColumnLayout {
        ...
        RowLayout { spacing: 8
            ...
            Text { text: LanguageManager.tr3("Use \"Exportar\" para ver distância total e velocidade media por campo.", "Use \"Export\" to view total distance and average speed per field.", "Use \"Exportar\" para ver distância total y velocidad media por campo.")
