...
// Passo 2 do fluxo CC: sele̤̣o do layout de campos e contexto.
//
// Regras de layout:
                ...
                Rectangle {
                    ...
                    Item {
                        ...
                        Rectangle {
                            ...
                            MouseArea {
                                anchors.fill: parent
                                enabled: root.selectedNumCampos >= 1 && !root.contextForced
                                hoverEnabled: true
                        ...
                        Rectangle {
                            ...
                            MouseArea {
                                anchors.fill: parent
                                enabled: root.selectedNumCampos >= 2 && !root.contextForced
                                hoverEnabled: true
                                cursorShape: Qt.PointingHandCursor
                                onClicked: {
                                    if (root.selectedContext !== "Contextual") root.selectedContext = "Contextual"
                        ...
                        Rectangle {
                            ...
                            MouseArea {
                                anchors.fill: parent
                                enabled: root.selectedNumCampos >= 3 && !root.contextForced
                                hoverEnabled: true
                                cursorShape: Qt.PointingHandCursor
                                onClicked: {
                                    if (root.selectedContext !== "Contextual") root.selectedContext = "Contextual"
