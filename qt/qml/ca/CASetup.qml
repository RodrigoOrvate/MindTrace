    ...
    ScrollView {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                Text {
                    text: LanguageManager.tr3("Campo Aberto", "Open Field", "Campo Abierto") + "  ·  " + root.numCampos + " " +
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    TextField {
                        id: nameField
                        Layout.fillWidth: true
                        placeholderText: LanguageManager.tr3("Ex.: CA_Control_GroupA", "Ex.: CA_Control_GroupA", "Ej.: CA_Grupo_ControlA")
                ...
                RowLayout {
                    ...
                    ComboBox {
                        ...
                        background: Rectangle {
                            ...
                            border.color: responsibleBox.activeFocus ? "#3d7aab" : ThemeManager.border
                            border.width: 1
                            Behavior on color { ColorAnimation { duration: 200 } }
                            Behavior on border.color { ColorAnimation { duration: 150 } }
                        }
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                ...
                                color: root.responsibleUnknown ? "#3d7aab" : ThemeManager.surfaceDim
                                border.color: root.responsibleUnknown ? "#3d7aab" : ThemeManager.border
                                border.width: 1.5
                                Behavior on color { ColorAnimation { duration: 150 } }
                                Behavior on border.color { ColorAnimation { duration: 150 } }
